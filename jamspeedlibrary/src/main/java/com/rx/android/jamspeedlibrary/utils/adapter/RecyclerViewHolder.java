...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerViewHolder setImageBitmap(int viewId, Bitmap bitmap, Activity activity) {
        ImageView view = getView(viewId);
        Glide
                .with(activity)
                .load(bitmap)
    ...
    public RecyclerViewHolder setImageBitmap(int viewId, Bitmap bitmap, Fragment fragment) {
        ImageView view = getView(viewId);
        Glide
                .with(fragment)
                .load(bitmap)
    ...
    public RecyclerViewHolder setImageURL(int viewId, String url, Fragment fragment) {
        ImageView view = getView(viewId);
        Glide
                .with(fragment)
                .load(Uri.parse(url))
    ...
    public RecyclerViewHolder setWidthHeightBaseWidth(int viewId, int width, int height) {
        View view = getView(viewId);
...
//     * @return
//     */
//    public RecyclerViewHolder setSimpleDraweeView(int viewId, String url) {
...
//    }
    ...
    public RecyclerViewHolder setSize(int viewId, int width, int height) {
        View view = getView(viewId);
        ViewGroup.LayoutParams lp = view.getLayoutParams();
        lp.width = width;
        lp.height = height;
