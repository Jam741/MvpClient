...
public class PersonInfoActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        tvNkname.setText(nikeName == null || nikeName.equals("") ? "设置昵称让大家认识你" : nikeName);
        tvMob.setText(mob);
    }

    private void initData() {
        portrait = getIntent().getStringExtra(KEY_PORTRAIT);
        LogUtil.getInstance().debug("jam", "-----------pp=============" + portrait);
        ...
        if (data != null && resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case request_code_nickkname:
                    nikeName = data.getStringExtra("KEY_INPUT_RESULT");
                ...
                .enqueue(new Callback<BaseBean<String>>() {
                    ...
                    public void onResponse(Call<BaseBean<String>> call, Response<BaseBean<String>> response) {
                        if (response.body().getSucc()) {
                            ...
                            T.showShort(context, R.string.net_network_fail);
                        }
