...
public class EditPersionInfoActivity extends BaseActivity {
    ...
    private void initEditTextNikeName() {
        ...
        edInput.addTextChangedListener(textWatcherNikename);


    }


    private TextWatcher textWatcherNikename = new TextWatcher() {
    ...
    private void initData() {
        ...
        switch (mCurrentType) {
            case NICKNAME:
                ...
                edInput.setFilters(new InputFilter[]{new InputFilter.LengthFilter(15)}); //最大输入长度
                break;
            case MOB:
                mTitle = "更改手机号";
