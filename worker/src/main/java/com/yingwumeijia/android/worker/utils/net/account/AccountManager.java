package com.yingwumeijia.android.worker.utils.net.account;
...
//            mCurrentAccount = (Account) StarterApplication.getInstance().accountFromJson(accountJson);
        }
    }
    ...
    private static Prefs prefs() {
        return Prefs.with(StarterApplication.appContext(), PREFS_ACCOUNT_STORAGE, Context.MODE_PRIVATE);
    }
