package com.yingwumeijia.android.worker.utils.net.retrofit;
...
/**
 * Created by Jam on 16/6/24 下午1:36.
 * Describe:
 */
public class PersistentCookieStore {
    ...
    public PersistentCookieStore(Context context) {
        ...
        for (Map.Entry<String, ?> entry : prefsMap.entrySet()) {
            String[] cookieNames = TextUtils.split((String) entry.getValue() == null ? "" : (String) entry.getValue(), ",");
